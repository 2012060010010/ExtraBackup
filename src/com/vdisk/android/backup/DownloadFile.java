...
public class DownloadFile extends AsyncTask<Void, Long, Boolean> {
	...
	public DownloadFile(Context context, VDiskAPI<?> api, String filePath, String targetPath) {
		...
		mDialog.setButton(DialogInterface.BUTTON_NEGATIVE,mContext.getString(R.string.be_cancel), new OnClickListener() {
	...
	protected Boolean doInBackground(Void... params) {
		try {
			...
			file = mApi.createDownloadDirFile(mTargetPath);//本地存储路径
